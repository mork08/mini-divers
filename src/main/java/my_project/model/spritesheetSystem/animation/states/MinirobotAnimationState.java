...
public enum MinirobotAnimationState implements IEntityAnimationState {
    ...
    MinirobotAnimationState(EntityDirection direction, EntityState state, int rowIndex, RangeInt columnRange, int frames, double duration) {
        this(direction, state, rowIndex, columnRange, frames, duration, true);
    }

    MinirobotAnimationState(EntityDirection direction, EntityState state, int rowIndex, RangeInt columnRange, int frames, double duration, boolean loop) {
        this(direction, state, rowIndex, columnRange, frames, duration, loop, false);
    }

    MinirobotAnimationState(EntityDirection direction, EntityState state, int rowIndex, RangeInt columnRange, int frames, double duration, boolean loop, boolean reverse) {
        this(direction, state, rowIndex, columnRange, frames, duration, loop, reverse, 0, 0);
    }

    MinirobotAnimationState(EntityDirection direction, EntityState state, int rowIndex, RangeInt columnRange, int frames, double duration, boolean loop, boolean reverse, int frameWidth, int frameHeight) {
